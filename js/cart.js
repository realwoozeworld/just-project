document.addEventListener("DOMContentLoaded", () => {
    ...
    checkoutBtn.addEventListener("click", () => {
      ...
      // Redirect to checkout page (you can replace it with actual checkout process)
      alert("Proceeding to checkout...");
      window.location.href = "checkout.html";  // Redirect to checkout page (create a checkout page if needed)
    });
